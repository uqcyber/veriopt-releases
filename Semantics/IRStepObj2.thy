...
next
  ...
  show ?case using LoadFieldNode step.cases
    by (smt (z3) IRNode.distinct(1333) IRNode.distinct(1347) IRNode.distinct(1349) IRNode.distinct(1353) IRNode.distinct(893) IRNode.inject(18) Pair_inject Value.inject(4) evalDet option.discI option.inject)
  next
...
next
  ...
  show ?case using StoreFieldNode step.cases
    by (smt (z3) IRNode.distinct(1353) IRNode.distinct(1783) IRNode.distinct(1965) IRNode.distinct(1983) IRNode.distinct(933) IRNode.inject(38) Pair_inject Value.inject(4) evalDet option.discI option.inject)
next
...
definition p3:: MapState where
  "p3 = set_params new_map_state [IntVal32 3]"
...
definition eg4_sq :: IRGraph where
  "eg4_sq = irgraph [
    ...
    (1, ParameterNode 0, default_stamp),
    (3, MulNode 1 1, default_stamp),
    (4, NewInstanceNode 4 ''obj_class'' None 5, (ReferenceStamp (ObjectStamp ''obj_class'' True True True))),
