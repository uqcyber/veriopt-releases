...
proof (induction rule: "step.induct")
  ...
  show ?case 
    by (smt (verit) SequentialNode step.cases is_sequential_node.simps(17,19,28,36,45,46,47)
        Pair_inject IRNode.discI(32))
next
  ...
  from notseq notend 
  show ?case
    by (smt (verit) FixedGuardNode.hyps(1,5) IRNode.distinct(993,1013,1035,1053,1055,1059)
        step.simps Pair_inject IRNode.inject(10))
next
  ...
  from notseq notend notdivrem show ?case
    by (smt (verit) IRNode.inject(11,12) Pair_inject step.simps IfNode repDet evalDet
        IRNode.distinct(993,1183,1205,1223,1225,1229))
next
...
next
  ...
  show ?case 
    by (smt (verit) NewInstanceNode step.cases IRNode.disc(1102,1013,1178,2367,2417,2419,2466)
        IRNode.discI(12) Pair_inject IRNode.distinct(1035,2525,2527) IRNode.inject(32,33))
next
  ...
  show ?case 
    by (smt (verit) LoadFieldNode step.cases repDet evalDet IRNode.inject(21,22) option.distinct(1)
        IRNode.distinct(991,1013,1157,1183,1827,1845,1847,1851,1935,1953,1955,1959) Pair_inject
...
next
  ...
  from notseq notend notdivrem
  show ?case  
    by (smt (verit) IRNode.distinct(991,1013,1157,1183,1827,1845,1847,1851,1935,1953,1955,1959)
...
next
  ...
  from notseq notend notdivrem
  show ?case 
    by (smt (verit) IRNode.distinct(1037,1059,1203,1229,1851,1959,2423,2531,2711,2733,2819,2841)
...
next
  ...
  from notseq notend
  show ?case  
    by (smt (verit) IRNode.distinct(1031,1053,1197,1223,1845,1953,2417,2525,2707,2711,2815,2819)
...
next
  ...
  from notseq notend
  show ?case 
    by (smt (verit) IRNode.distinct(1033,1055,1199,1225,1847,1955,2419,2527,2707,2733,2815,2841)
...
lemma step_in_ids:
  ...
  by (metis IRNode.distinct(1075,1245,1975,2547,2835,2857,2895) IRNode.disc(1374,2895) ids_some
